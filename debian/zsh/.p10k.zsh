# Generated by Powerlevel10k configuration wizard on 2024-01-05 at 13:49 IST.
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_BRANCH_ICON='\U1F384' 
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local   modified='%213F'  # yellow foreground
  ...
  #################[ ranger: ranger shell (https://github.com/ranger/ranger) ]##################
  # Ranger shell color.
  typeset -g POWERLEVEL9K_RANGER_FOREGROUND=183
  # Custom icon.
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=216
